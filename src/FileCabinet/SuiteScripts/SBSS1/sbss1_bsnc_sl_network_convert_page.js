 ...
 */
function bsnNetworkConvertPage(request, response){
    if ( request.getMethod() == 'GET' ){
        ...
        var form = nlapiCreateForm(netName + ' Network Convertion Info');
        ...
        //form.setScript('customscript_sbss1_bsnc_cs_network_conv');
